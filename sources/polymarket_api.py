            ...
            for event in events_data:
                ...
                for m in event.get("markets", []):
                    ...
                    try:
                        ...
                        # Handle exact string mapping or list mapping
                        yes = float(prices[0]) if isinstance(prices, list) else float(prices.get("Yes", "0.5"))
                        no = float(prices[1]) if isinstance(prices, list) else float(prices.get("No", "0.5"))
